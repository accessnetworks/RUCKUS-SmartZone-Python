...
class vSZ_calls:
	...
	def uploadFirmware(self, host, token):
		url = "https://" + host + ":8443" + "/wsg/api/public/v9_0/upgrade/upload?serviceTicket=" + token
		payload={}
		files=[('file',('vscg-5.2.1.0.515.ximg',open('/Users/marcelo/Documents/Codes/ova images/vscg-5.2.1.0.515.ximg','rb'),'application/octet-stream'))]
		r = requests.post(url, files=files, verify=False)
		return r

	# Uograde SmartZone firmware
